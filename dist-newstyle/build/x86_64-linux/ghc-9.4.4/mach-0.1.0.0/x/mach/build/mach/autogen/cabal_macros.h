...
/* package mach-0.1.0.0 */
#ifndef VERSION_mach
#define VERSION_mach "0.1.0.0"
#endif /* VERSION_mach */
#ifndef MIN_VERSION_mach
#define MIN_VERSION_mach(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mach */
...
#define CURRENT_COMPONENT_ID "mach-0.1.0.0-inplace-mach"
